  ...
  <div>
    <div class="container">
      <div class="handle-box">
         <el-input v-model="query.gid" placeholder="请选择商品" class="handle-input mr10"></el-input>
    ...
    <el-dialog :title="dialogName" :visible.sync="dialogVisible" width="35%">
        ...
        <el-form-item label="用户" prop="uid">
            <el-input v-model="form.uid" placeholder="用户"></el-input>
        </el-form-item>
      </el-form>
