  ...
  <div>
    <div class="container">
      <div class="handle-box">
         <el-input v-model="query.outfitName" placeholder="请输入穿搭名称" class="handle-input mr10"></el-input>
         <el-button type="primary" icon="el-icon-search" @click="getData">查询</el-button>
      </div>
      <el-table :data="tableData" border class="table" ref="multipleTable" header-cell-class-name="table-header" >
        <el-table-column type="selection" width="55" align="center"></el-table-column>
        <el-table-column prop="outfitName" label="名称" align="center">
        ...
        <el-table-column label="操作" align="center" width="260" >
          <template slot-scope="scope">
            <el-button  type="primary" icon="el-icon-edit" size="mini" v-if="type=='02' && scope.row.uid !== userInfo.id" @click="handleEdit(scope.$index, scope.row)">回复</el-button>
    ...
    <el-dialog :title="dialogName" :visible.sync="dialogVisible" width="35%">
        ...
        <el-form-item label="回复内容" prop="reply">
            <el-input type="textarea" rows="5" v-model="form.reply" placeholder="回复内容"></el-input>
        </el-form-item>
      </el-form>
...
export default {
  ...
  data() {
    return {
        ...
        rules: {
          oid: [
              { required: true, message: '请输入穿搭', trigger: 'blur' },
          ],
          uid: [
