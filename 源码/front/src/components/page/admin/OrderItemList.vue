  ...
  <div>
    <div class="container">
      <div class="handle-box">
         <el-input v-model="query.oid" placeholder="请选择订单" class="handle-input mr10"></el-input>
         <el-button type="primary" icon="el-icon-search" @click="getData">查询</el-button>
         <el-button type="primary" icon="el-icon-plus" @click="handleAdd">添加</el-button>
      </div>
      <el-table :data="tableData" border class="table" ref="multipleTable" header-cell-class-name="table-header" >
        <el-table-column type="selection" width="55" align="center"></el-table-column>
        <el-table-column prop="ordersNo" label="订单编号" align="center"></el-table-column>
    ...
    <el-dialog :title="dialogName" :visible.sync="dialogVisible" width="35%">
        ...
        <el-form-item label="订单" prop="oid">
            <el-input v-model="form.oid" placeholder="订单"></el-input>
        </el-form-item>
        <el-form-item label="商品" prop="gid">
            <el-input v-model="form.gid" placeholder="商品"></el-input>
        </el-form-item>
        <el-form-item label="数量" prop="num">
            <el-input type='number' oninput="if(value<0)value=0" v-model="form.num" placeholder="数量"></el-input>
        </el-form-item>
